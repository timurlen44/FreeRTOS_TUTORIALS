...
void myTaskFunc(void const * argument);
...
int main(void)
{
  ...
  osThreadDef(myTask, myTaskFunc, osPriorityNormal, 0, 128);
...
/* USER CODE BEGIN Header_myTaskFunc */
/**
  * @brief  Function implementing the myTask thread.
  * @param  argument: Not used
  * @retval None
  */
/* USER CODE END Header_myTaskFunc */
void myTaskFunc(void const * argument)
{
  /* USER CODE BEGIN 5 */
  /* Infinite loop */
  uint32_t tim = HAL_GetTick()+500;
  for(;;)
  {
	  if(tim<HAL_GetTick())
	  {
