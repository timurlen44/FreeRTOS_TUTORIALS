...
int main(void)
{
  ...
  osThreadDef(Task1, Task1_Func, osPriorityNormal, 0, 128);// STM32CubeIDEMX otomatik oluşturuyor
  Task1Handle = osThreadCreate(osThread(Task1), NULL);// STM32CubeIDEMX otomatik oluşturuyor

  /* definition and creation of Task2 */
  osThreadDef(Task2, Task2_Func, osPriorityNormal, 0, 128);// STM32CubeIDEMX otomatik oluşturuyor
  Task2Handle = osThreadCreate(osThread(Task2), NULL);// STM32CubeIDEMX otomatik oluşturuyor
  ...
  /* Start scheduler */
  osKernelStart();//Bu fonksiyon yerine vTaskStartScheduler(); kullanabiliriz ikiside aynı işi yapıyor
...
static void MX_GPIO_Init(void)
{
  ...
  HAL_GPIO_WritePin(GPIOA, RedLED_Pin|GreenLED_Pin|LD2_Pin, GPIO_PIN_RESET);
  ...
  /*Configure GPIO pins : RedLED_Pin GreenLED_Pin LD2_Pin */
  GPIO_InitStruct.Pin = RedLED_Pin|GreenLED_Pin|LD2_Pin;
