...
osMessageQId Button_Information_QueueHandle;
/* USER CODE BEGIN PV */
...
int main(void)
{
  ...
  */
  ...
  osThreadDef(SenderTask, SenderTaskFunc, osPriorityNormal, 0, 128);
  SenderTaskHandle = osThreadCreate(osThread(SenderTask), NULL);

  /* definition and creation of ReceiverTask */
  osThreadDef(ReceiverTask, ReceiverTaskFunc, osPriorityNormal, 0, 128);
...
/* USER CODE BEGIN Header_SenderTaskFunc */
/**
...
/* USER CODE BEGIN Header_ReceiverTaskFunc */
/**
